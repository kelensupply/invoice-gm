import { s as store_get, i as head, b as attr, c as escape_html, a as attr_class, d as unsubscribe_stores, g as derived, f as stringify } from "../../../../chunks/index.js";
...
function _page($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    var $$store_subs;
    const clientId = store_get($$store_subs ??= {}, "$page", page).params.id;
    const client = derived(() => store_get($$store_subs ??= {}, "$clients", clients).find((c) => c.id === clientId));
    let companyName = "";
    let contactName = "";
    let email = "";
    let countryCode = "+1";
