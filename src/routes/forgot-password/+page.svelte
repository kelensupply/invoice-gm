...
<svelte:head>
    <title>Forgot Password - Invoicer App</title>
</svelte:head>
    ...
    <div class="sm:mx-auto sm:w-full sm:max-w-md relative z-10 px-4 sm:px-0">
        ...
        >
            <div class="mb-8 text-center">
                <div
                    class="mx-auto w-12 h-12 bg-blue-500 rounded-xl flex items-center justify-center text-white mb-6 shadow-lg shadow-blue-500/30"
                >
                    <svg
                ...
                >
                    <div class="mb-6">
                        ...
                        <input
                            ...
                            class="block w-full rounded-xl border border-slate-200 bg-white/50 px-4 py-3 text-slate-900 placeholder-slate-400 focus:border-blue-500 focus:bg-white focus:ring-4 focus:ring-blue-500/10 transition-all duration-200 outline-none sm:text-sm"
                        />
                    </div>
