...
<span
    class="inline-flex items-center justify-center px-2.5 py-0.5 text-[10px] font-black uppercase tracking-widest rounded-md border {item.style} whitespace-nowrap"
>
    {item.label}
</span>
